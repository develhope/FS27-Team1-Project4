...
export function DeepStolenNode({ stolen, id }) {
  return (
    <div
      className={`flex items-center justify-center relative stolen ${
        stolen ? "is-stolen" : ""
      }`}
    >
      <div className="base">
        ...
        <div className="random-number-container">
          <div>
            <DeepRandomString stringLength={9} />
          </div>
        </div>
        <div className="game-name-container">{id}</div>
      </div>
    </div>
  );
}
