...
import {
  ...
  checkBrandUnique,
  checkGearUnique,
  checkIfItemAlreadyInOrder,
  checkNewsletterSubscriberUnique,
  checkPcUnique,
  checkUsernameOrEmailUnique,
} from "./middleware.js";
import "./passport.js";
...
import {
  ...
  updateBrand,
  updateGear,
  updateGearIncomingStock,
  updateGearStock,
  updatePc,
  updatePcIncomingStock,
  updatePcStock,
...
import { gameCompleted } from "./controllers/games.js";
...
app.put(
  "/api/products/gears/update/incoming-stock/:id",
  updateGearIncomingStock
);
...
/* api for the games */
app.put("/api/game/completed/:id", gameCompleted);
